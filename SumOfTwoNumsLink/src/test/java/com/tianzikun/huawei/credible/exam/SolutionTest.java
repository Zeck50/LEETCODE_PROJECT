    ...
    extends TestCase
{
    ...
    public void testApp()
    {
        ListNode list1Bit=new ListNode(0);
        ListNode list2Bit=new ListNode(0);
        ListNode resultListBit=new ListNode(0);

        ListNode list1Ten=new ListNode(1);
        ListNode list2Ten=new ListNode(1);
        ListNode resultListTen=new ListNode(2);

        ListNode list1Hundred=new ListNode(2);
        ListNode list2Hundred=new ListNode(2);
        ListNode resultListHundred=new ListNode(4);
